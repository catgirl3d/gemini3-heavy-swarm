    ...
    fetch('/api/status')
      .then(res => {
        ...
        if (!res.ok || !contentType || !contentType.includes('application/json')) {
          // If not JSON (e.g. Vite serving index.html for 404s), assume no server
          return null;
        }
        return res.json();
      })
    ...
    <div className="chat-container">
      {isMissingKey && !isBannerDismissed && (
        <div className="demo-banner">
            ...
            <button className="banner-close-btn" onClick={() => setIsBannerDismissed(true)} aria-label="Dismiss banner">
      ...
      {isProxyPrivate && !isBannerDismissed && (
        <div className="demo-banner success">
            <div className="demo-banner-content">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="demo-banner-icon">
